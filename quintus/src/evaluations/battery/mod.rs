...
pub fn new_battery_composer(no_electrode_layers: usize, outer_electrode: Electrode) -> Composer {
    Composer {
        ...
        require_component_types: HashSet::from(["anode".to_string(), "cathode".to_string(), "foil".to_string(), "separator".to_string()]),
        properties: HashMap::from([
            (String::from("NO_ELECTRODE_LAYERS"), PropertyType::Int(no_electrode_layers)),
            (String::from("OUTER_ELECTRODE_LAYER"), match outer_electrode {
